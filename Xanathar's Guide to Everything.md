...
*The items in the [items.html](Items) page are classified as major or minor according to tables originally found in this section.*
...
*I can disintegrate things whenever I want. Like now. And now. And now. And now... Hey, where'd everybody go?*— Xanathar![](img/book/XGE/c3001.webp)
...
See the variant rules entry for more information.
...
See the [names.html](names) page for the full collection of name tables.

![](img/book/XGE/ab001.webp)
